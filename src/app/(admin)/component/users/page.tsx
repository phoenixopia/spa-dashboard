...
import { faLayerGroup, faPlus, faSquareRss, faUser } from '@fortawesome/free-solid-svg-icons';
...
export default function User() {
  ...
  const data = [
    { name: 'Apple MacBook Pro 17"', phone: '1111232456', email:'asdfasdga', date: '2023-10-01' },
    { name: 'Microsoft Surface Pro', phone: '1345678909', email:'asdfasdga', date: '2023-10-02' },    
    { name: 'Microsoft Surface Pro', phone: '657483902' ,email:'asdfasdga',  date: '2023-10-02'},
    { name: 'Magic Mouse 2', phone: '5678920', email:'asdfasdga', date: '2023-10-02' },
    { name: 'iPhone 13', phone: '1029348576' , email:'asdfasdga', date: '2023-10-02'},
    { name: 'iPad Pro', phone: '1092384756' , email:'asdfasdga', date: '2023-10-02'},
    { name: 'Apple Watch', phone: '1029384576', email:'asdfasdga', date: '2023-10-02' },
    { name: 'AirPods Pro', phone: '102938475', email:'asdfasdga', date: '2023-10-02' },
    { name: 'Dell XPS 13', phone: '0129384756' , email:'asdfasdga', date: '2023-10-02'},
  ];
          ...
          <div className="bg-white shadow-md rounded-2xl p-4 sm:p-6 dark:bg-gray-900">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                <p className="text-green-700 font-medium whitespace-nowrap">All Users</p>
                <input
                  type="text"
                  placeholder="Search..."
