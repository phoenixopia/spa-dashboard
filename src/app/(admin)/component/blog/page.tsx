    ...
    <div className="relative bg-cover bg-center min-h-screen">
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-6 space-y-20 md:ml-[260px]">
        <div className="max-w-7xl w-full mx-auto">
          <h2 className="text-2xl font-semibold text-gray-800 mb-8 dark:text-amber-50">Blog Management</h2>
        ...
        onAdd={fetchData} // Pass the fetchData function to refresh the list after adding a blog
      />
