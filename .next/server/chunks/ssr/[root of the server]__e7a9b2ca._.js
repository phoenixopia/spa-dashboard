...
function UserSettings() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchUserData = async ()=>{
            try {
                const response = await fetch(`${("TURBOPACK compile-time value", "https://spa-backend-test.vercel.app/api")}/user`);
    ...
    const handleChange = async ()=>{
        if (editField === 'name' && tempValue.trim()) {
            ...
            if (newPassword === confirmPassword && newPassword.length >= 6) {
                ...
                const response = await fetch(`${("TURBOPACK compile-time value", "https://spa-backend-test.vercel.app/api")}/user/edit`, {
                    method: 'PUT',
                    headers: {
            ...
            // Send PUT request for name or email
            const response = await fetch(`${("TURBOPACK compile-time value", "https://spa-backend-test.vercel.app/api")}/user/edit`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
            ...
            if (response.ok) {
                if (editField) {
                    alert(`${editField.charAt(0).toUpperCase() + editField.slice(1)} updated!`);
                }
            } else {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e7a9b2ca._.js.map