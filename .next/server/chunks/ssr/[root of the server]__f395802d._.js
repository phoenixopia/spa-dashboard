...
function ResetPasswordPage() {
    ...
    const handleReset = async (e)=>{
        ...
        setLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${BURL}/auth/reset`, {
                email,
                password: newPassword,
                token: resetToken
            });
            const msg = response.data?.message || "Password successfully updated.";
            setSuccess(msg);
            setEmail("");
            setNewPassword("");
            setConfirmPassword("");
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f395802d._.js.map