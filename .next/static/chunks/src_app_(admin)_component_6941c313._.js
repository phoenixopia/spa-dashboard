(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_(admin)_component_6941c313._.js", {
...
"[project]/src/app/(admin)/component/category/delete.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const DeletecategoryModal = ({ isOpen, onClose, categoryId, onDeleted })=>{
    const handleDelete = async ()=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${BURL}/category/delete/${categoryId}`, {
                headers: {
...
var _c;
__turbopack_context__.k.register(_c, "DeletecategoryModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/app/(admin)/component/category/add.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const AddcategoryModal = ({ isOpen, onClose, onSave, newcategory, onChange })=>{
        ...
        "AddcategoryModal.useEffect": ()=>{
            if (isOpen) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${BURL}/category`).then({
                    "AddcategoryModal.useEffect": (res)=>{
                        setCategories(res.data.data);
                        setError(null);
                    }
                }["AddcategoryModal.useEffect"]).catch({
                    "AddcategoryModal.useEffect": (err)=>{
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            setLoading(true);
            const token = document.cookie.split('; ').find((row)=>row.startsWith('token='))?.split('=')[1] || '';
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${BURL}/category/create`, formData, {
                headers: {
                    Authorization: `Bearer ${token}`,
...
_s(AddcategoryModal, "4SFfOJ8IfU7tZBxursoQLMxjmNA=");
_c = AddcategoryModal;
...
"[project]/src/app/(admin)/component/category/edit.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const EditcategoryModal = ({ showModal, setShowModal, editForm, handleEditChange, categoryId, BURL })=>{
    ...
    const handleSave = async ()=>{
        ...
        try {
            const token = document.cookie.split('; ').find((row)=>row.startsWith('token='))?.split('=')[1] || '';
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${BURL}/category/edit/${categoryId}`, editForm, {
                headers: {
                    Authorization: `Bearer ${token}`,
                    "Content-Type": "multipart/form-data"
                },
...
_s(EditcategoryModal, "BCgQMdlykVS2unodGhJ3kBOsNN8=");
...
"[project]/src/app/(admin)/component/category/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/axios/lib/axios.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$admin$292f$component$2f$category$2f$delete$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/(admin)/component/category/delete.tsx [app-client] (ecmascript)"); // Adjust path if needed
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$admin$292f$component$2f$category$2f$add$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/(admin)/component/category/add.tsx [app-client] (ecmascript)"); // import the modal component
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$admin$292f$component$2f$category$2f$edit$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/(admin)/component/category/edit.tsx [app-client] (ecmascript)"); // import the modal component
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function Category() {
    ...
    const handleAddSave = async ()=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${BURL}/category/create`, newcategory, {
                headers: {
                    Authorization: `Bearer ${token}`
                },
                withCredentials: true
    ...
    const fetchData = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${BURL}/category`);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Category.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${BURL}/category`).then({
                "Category.useEffect": (res)=>{
                    const map = {};
                    res.data.data.forEach({
                        "Category.useEffect": (cat)=>{
                            map[cat.id] = cat.name;
                        }
                    }["Category.useEffect"]);
                    setCategoryMap(map);
                }
            }["Category.useEffect"]).catch({
                "Category.useEffect": (err)=>console.error("Failed to load categories", err)
            }["Category.useEffect"]);
        }
    }["Category.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$admin$292f$component$2f$category$2f$add$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    isOpen: addModal,
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$admin$292f$component$2f$category$2f$edit$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            showModal: showModal,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$admin$292f$component$2f$category$2f$delete$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(Category, "rot7vWbsLR8NfjyID8cd0zoBhTU=");
_c = Category;
var _c;
...
//# sourceMappingURL=src_app_%28admin%29_component_6941c313._.js.map