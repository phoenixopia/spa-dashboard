...
const EdittestimonialModal = ({ showModal, setShowModal, editForm, handleEditChange, testimonialId, BURL, refresh })=>{
    ...
    const handleSave = async ()=>{
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`${BURL}/testimonial/edit/${testimonialId}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                    "Content-Type": "multipart/form-data"
                },
...
_s(Testimonial, "gCP3Wd/YmFxqs7azs4A0CWl4YcA=");
_c = Testimonial;
var _c;
