(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_(admin)_component_989989de._.js", {
...
const DeleteUserModal = ({ isOpen, onClose, userId, onDeleted })=>{
    const handleDelete = async ()=>{
        if (!userId) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`${BURL}/user/${userId}`);
...
function User() {
    ...
    const handleAddSave = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${BURL}/user`, newUser);
...
_s(User, "9wvmsjvfCINh25VvSXSk/I95QpI=");
_c = User;
var _c;
...
//# sourceMappingURL=src_app_%28admin%29_component_989989de._.js.map