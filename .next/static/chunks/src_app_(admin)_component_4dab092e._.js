        ...
        "AddserviceModal.useEffect": ()=>{
            if (isOpen) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${BURL}/category`).then({
                    "AddserviceModal.useEffect": (res)=>{
                        setCategories(res.data.data);
                        console.log('Fetched Categories:', res.data.data);
                    }
                }["AddserviceModal.useEffect"]).catch({
                    "AddserviceModal.useEffect": (err)=>console.error('Error fetching categories:', err)
                }["AddserviceModal.useEffect"]);
            }
        }
    }["AddserviceModal.useEffect"], [
...
_s(AddserviceModal, "qXrSgth/iPRhxHsILCg6/csU2zw=");
_c = AddserviceModal;
...
const EditserviceModal = ({ showModal, setShowModal, editForm, handleEditChange, serviceId, BURL, onSaveSuccess, onEdited })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditserviceModal.useEffect": ()=>{
            if (showModal) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${BURL}/category`).then({
                    "EditserviceModal.useEffect": (res)=>{
                        setCategories(res.data.data);
                    }
                }["EditserviceModal.useEffect"]).catch({
                    "EditserviceModal.useEffect": (err)=>{
...
_s(EditserviceModal, "+HDonIfy2Un2jQ/reqB4y4FwlTs=");
_c = EditserviceModal;
...
_s(Service, "EG2KC5Ufup8+gBOjTZHRRlSv48k=");
_c = Service;
var _c;
